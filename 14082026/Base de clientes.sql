...
update clientes 
set email = 'gabriela.costa@gmail.com'
where id_cliente = 7;
...
update clientes 
set cidade = 'Caxias de Sul'
where id_cliente = 9;

update clientes 
set email = 'vinicius@empresa.com'
where id_cliente = 20;
...
select id_cliente, nome, email, cidade, idade, genero from clientes;