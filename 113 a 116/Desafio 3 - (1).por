programa {
  ...
  funcao inicio() {
    ...
    real precoDoProduto, valorAtual = 0, calcularDescoto, percentualDesconto
    faca {
      escreva("--------CAIXA--------\n")
      ...
      se (opcao < 1 ou opcao > 4) {
        ...
        escreva("Quantidade: ")
        leia(quantidade)
        escreva(calcularValorVendas(precoDoProduto, quantidade), "\n")
        ...
        escreva(calcularDescoto(valorAtual, percentualDesconto), "\n")

        totalCaixa-=calcularDescoto(valorAtual, percentualDesconto)
